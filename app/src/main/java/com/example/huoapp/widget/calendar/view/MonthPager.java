...
public class MonthPager extends ViewPager {
    ...
    private List<CalendarDate> days = new ArrayList<>();
     ...
     * 签到
     */
    public void setSignDays(List<CalendarDate> calendarDates){
        this.days.addAll(calendarDates);
    }

    public void signDay(CalendarDate calendarDate){
