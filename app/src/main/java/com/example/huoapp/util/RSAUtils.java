...
public class RSAUtils {
    ...
    public static byte[] decryptByPublicKey(byte[] encryptedData, String publicKey)
            throws Exception {
        LogUtils.e("decryptByPublicKey","data="+new String(encryptedData,"utf-8"));
        try{
            //解密的数据一般是base64过后的，需要先解码
            encryptedData=decryptBASE64(new String(encryptedData,"utf-8"));
...
//        Cipher cipher = Cipher.getInstance(keyFactory.getAlgorithm());
            ...
            out.close();
            LogUtils.e("decryptByPublicKey","解密数据为："+new String(decryptedData,"utf-8"));
            return decryptedData;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public static byte[] encryptByPublicKey(byte[] data, String publicKey)
        ...
        try {
            ...
            out.close();
            //对返回数据base64编码，防止乱码
            return encryptBASE64(encryptedData).getBytes();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
